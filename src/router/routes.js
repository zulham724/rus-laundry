...
const routes = [
...

    {
        path: "/search-owner",
        component: () =>
            import ("src/pages/SearchOwner.vue"),
        beforeEnter: multiguard([auth, checkIfOwner]),
    },
...

    {
        ...
        component: () =>
            import ("pages/AffiliateOwner.vue"),
        beforeEnter: multiguard([auth, checkIfOwner]),
    },
...

    {
        ...
        component: () =>
            import ("src/pages/DetailProdukOwner.vue"),
        beforeEnter: multiguard([auth, checkIfOwner]),
    },
...

    {
        ...
        component: () =>
            import ("pages/attendanceScanPage.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },

    {
        path: "/OrderScanPage",
        component: () =>
            import ("pages/OrderScanPage.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },

    {
        path: "/addspend",
        component: () =>
            import ("pages/AddPengeluaran.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("pages/myprofileLike.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("pages/CameraPreitem.vue"),
        props: true,
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("pages/HistoryOfCourse.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("pages/DetailCourse2.vue"),
        props: true,
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("src/pages/AttendanceMenu.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("src/pages/AttendanceDetailsMenu.vue"),
        props: true,
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("src/pages/edit-post.vue"),
        props: true,
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        path: "/shop-location",
        component: () =>
            import ("src/pages/ShopLocation.vue"),
        beforeEnter: multiguard([auth, checkIfSlave]),
    },
...

    {
        ...
        component: () =>
            import ("src/pages/ProfileOther2.vue"),
        props: true,
        beforeEnter: multiguard([auth, checkIfSlave]),
    },

    {
        path: "/test-scan-a",
        component: () =>
            import ("src/pages/testScanA.vue"),
    },
    {
        path: "/mmm",
        component: () =>
            import ("src/pages/mmm.vue"),
    },
