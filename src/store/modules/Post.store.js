...
const actions = {
    ...
    deletePost({ commit }, post_id) {
        return new Promise((resolve, reject) => {
            ...
            api
                .delete(`/api/slave/post/${post_id}`, access)
                .then((res) => {
    ...
    getPostByUser({ commit }, userid) {
        return new Promise((resolve, reject) => {
            api
                .get(`/api/slave/getpostbyuser/${userid}`)
                .then((res) => {
    ...
    getLikedPostByUser({ commit }, userid) {
        return new Promise((resolve, reject) => {
            api
                .get(`/api/slave/getlikedpostbyuser/${userid}`)
                .then((res) => {
