    ...
    >
      ...
      >
        <div class="row full-width q-px-md">
          ...
          <div
            class="col-2 self-center text-center"
            v-if="dataAuth"
          >
            <!--Avatar-->
            <div
                          ...
                          >
                            ...
                            >
                              <template v-slot:error>
                                <div class="absolute-full flex flex-center bg-grey-5 text-white">
                    ...
                    >
                      ...
                      >
                        <q-card class="full-width">
                          ...
                          >
                            NOTE: Segala bentuk transaksi di marketplace merupakan tanggung jawab pengguna. Laundry digital tidak bertanggung jawab jika terdapat penipuan di dalam transaksi.
                            </div>
                            </div>
                        ...
                        >
                          <q-card class="full-width">
                            ...
                            <div
                              ...
                              style="color: #747474; font-size: 12px"
                            >
                              Silahkan masukan nomor WhatsApp aktif. Nomor tsb akan digunakan sebagai media transaksi oleh penjual dan pembeli.
                              </div>
                              </div>
                          ...
                          <q-dialog
                            v-model="dialogAfterInputWhatsapp"
                            persistent
                          >
                            <q-card class="full-width">
                              <!-- Gif Warning -->
