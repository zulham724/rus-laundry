    ...
    <q-page-container>
      ...
      <q-page>
        ...
        <div class="q-px-xl q-py-md">
          <!-- Search bar -->
          <div class="row full-width bg-red">
            <q-input
              dense
        ...
        <!-- History of today -->
        <div class="row q-px-sm text-weight-medium q-pb-xs" style="color: #4f4f4f; font-size: 12px">Hari ini</div>
        ...
        >
          <!-- Thumbnail video -->
          <div class="col-5 text-center self-center q-py-xs">
            <q-avatar
              square
        ...
        <!-- History of the week -->
        <div class="row q-px-sm text-weight-medium q-pb-xs" style="color: #4f4f4f; font-size: 12px">Minggu ini</div>
