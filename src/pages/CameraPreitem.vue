...
export default {
  ...
  mounted() {
    console.log("orderid", this.service_id);
  ...
  methods: {
    ...
    savePhoto() {
      //proses pindah halaman menuju basket dan mengirim file photo
      ...
      let file = new File([this.blob], "foto_pre_order");
      console.log("ini file photo", file);
      this.$store.commit("Orders/add_pre_order_photo", {
